...
class MenuModel extends CI_Model
{
  ...
  {
    return array(array("id"=>1,"nombre"=>"Asesoría", "imagen"=>"../servidor_legalhelp/img/asesoria.svg"),
  ...
  {
     return array(array("id"=>1,"nombre"=>"1. Direccionar", "imagen"=>"../servidor_legalhelp/img/paso1.svg", "descripcion"=>"Identificar el caso"),
  ...
  {
    return array(array("id"=>1,"nombre"=>"Tipo de identificación", "imagen"=>"../servidor_legalhelp/img/tipo_identificacion.svg"),
  ...
  {
    return array(array("id"=>1,"nombre"=>"1. Direccionar", "imagen"=>"../servidor_legalhelp/img/paso1.svg"),
